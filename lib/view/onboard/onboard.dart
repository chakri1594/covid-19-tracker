import 'package:covid_19_tracker/view/onboard/action_button.dart';
import 'package:covid_19_tracker/view/screens/routes.dart';
import 'package:covid_19_tracker/view/onboard/onboard_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:flutter_svg/svg.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';
import 'package:covid_19_tracker/view/onboard/multi_colored_text.dart';
import 'package:covid_19_tracker/view/onboard/colored_text.dart';
        ...
        children: [
          PageView(
            ...
            children: <Widget>[
              SizedBox(
                child: OnboardPage(
                  image: SvgPicture.asset("assets/icons/onboard1.svg"),
              ...
              OnboardPage(
                image: SvgPicture.asset("assets/icons/onboard2.svg"),
                multiColoredText: const MultiColoredText(textItems: [
...
/*
              ...
              OnboardPage(
                image: SvgPicture.asset("assets/icons/onboard3.svg"),
                multiColoredText: const MultiColoredText(textItems: [
              ...
              OnboardPage(
                image: SvgPicture.asset("assets/icons/onboard4.svg"),
                multiColoredText: const MultiColoredText(textItems: [
      ...
      children: <Widget>[
        ...
        SmoothPageIndicator(
          ...
          effect: ScrollingDotsEffect(
              dotWidth: 12.0,
              dotHeight: 12.0,
              activeDotColor: const Color(0xFF1B8D59),
